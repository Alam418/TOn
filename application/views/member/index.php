...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  <h5 class="my-0 mr-md-auto font-weight-normal">NatureS</h5>
  <nav class="my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" href="http://localhost/TokoOnline/index.php/member/c_member">Home</a>
    <a class="p-2 text-dark" href="#">Products</a>
    <a class="p-2 text-dark" href="#">Support</a>
  </nav>
  <a class="btn btn-outline-success login-btn bg-success" href="<?php echo site_url('admin/c_admin/logout'); ?>">Logout</a>
</div>

<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-success">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal text-white">Halo Member! (￣▽￣)ゞ</h1>
    <p class="lead font-weight-normal text-white">Selamat menikmati berbelanja</p>
